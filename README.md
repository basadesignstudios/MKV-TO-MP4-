...
- If Windows reports that "the ordinal 380 could not be located" when starting the
  packaged executable, the system shell32/user32 libraries are missing the drag-and-drop
  entry points used by newer Windows versions. The application automatically falls back
  to manual file selection in this scenario—use the **Convert** button or drop files onto
  the app icon to begin a batch.
